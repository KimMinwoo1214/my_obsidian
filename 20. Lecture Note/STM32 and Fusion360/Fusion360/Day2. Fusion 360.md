...
### [[Sweep]]
단축키: 없음
하나의 면을 선택하고 Path로 선택할 선을 골라 면이 선을 따라 입체가 된다.

### [[Shell]]
단축키: 없음
입체 모양을 선택해 구멍을 뚫을 수 있다. 이 때 Selected 버튼을 누르고 Ctrl키를 누른 채로 다른 면을 고르면 그 면 까지 구멍이 뚫리게 된다.

### [[Offset]] [[Plane]]
단축키: 없음
한 면을 선택해 그 면으로부터 지정한 거리만큼 떨어진 면을 잡아준다.

### [[Loft]]
단축키: 없음
면을 두 개를 골라 둘을 이어주는 선을 그려준다. 
## [[Sketch]] 실습1 - 볼트 만들기
